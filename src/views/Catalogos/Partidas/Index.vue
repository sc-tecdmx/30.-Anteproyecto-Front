                    ...
                    <div class="card-header pb-0">
                        <div class="row mb-3">
                            <div class="col-6 d-flex align-items-center">
                                <h4 class="mb-0">Partidas</h4>
                            </div>
                            <div class="col-6 text-end">
                                <button class="btn btn-dark" variant="gradient" @click="addSplit()">
                        ...
                        <div class="table-responsive p-0">
                            ...
                            >
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Capitulo</th>
                            ...
                            <tbody>
                                <tr v-for="(split, index) in splits" :key="index">
                                    ...
                                    <td class="text-center">
                                        <p class="text-xs font-weight-bold mb-0">{{ split.capitulo }}</p>
                                    </td>
                                    <td class="text-center">
                                        <p class="text-xs font-weight-bold mb-0">{{ split.concepto }}</p>
                                    </td>
                                    <td class="text-center">
                                    ...
                                    <td class="align-middle">
                                        <div class="row">
                                            ...
                                            <div class="col-4">
                                                <button class="p-0 btn btn-link text-dark fixed-plugin-close-button" @click="detail(split.id)">
                                                    <i class="fa fa-info"></i>
                                                </button>
                                            </div>
                                            <div class="col-4">
                                                <button class="p-0 btn btn-link text-dark fixed-plugin-close-button" @click="del(split.id)">
...
export default {
    ...
    setup() {
        ...
        const detail = (id) => {
            router.push(`/catalogos/partidas/${id}/capitulos`)
        }
