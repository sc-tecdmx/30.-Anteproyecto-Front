                        ...
                        <form @submit.prevent="store">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <select v-model="execution.mes_id" class="form-select" id="split_id">
...
export default {
    ...
    setup() {
        ...
        const store = async () => {
            await axios.post(`${process.env.VUE_APP_API_URL}/contratos/${route.params.id}/ejecucion`, execution.value)
                .then(() => {
                    Swal.fire(
                        '¡Éxito!',
